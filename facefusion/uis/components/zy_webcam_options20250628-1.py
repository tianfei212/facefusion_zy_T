...
def render() -> None:
	...
	global HD_GALLERY_DIRECTORY

	HD_GALLERY_DIRECTORY = gradio.Textbox(
		label=wording.get('uis.hd_gallery_directory_textbox'),
		placeholder=wording.get('uis.hd_gallery_directory_placeholder'),
		max_lines=1
	)
	register_ui_component('hd_gallery_directory', HD_GALLERY_DIRECTORY)
