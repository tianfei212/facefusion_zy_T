...
WORDING: Dict[str, Any] = {
    ...
    "uis": {
        ...
        "deep_swapper_model_dropdown": "选择模型",
        "deep_swapper_morph_slider": "图像融合度",
        "execution_providers_checkbox_group": "处理引擎",
        ...
        "face_swapper_model_dropdown": "选择图片换脸模型",
        "face_swapper_pixel_boost_dropdown": "像素加速单元大小",
        ...
        "processors_checkbox_group": "处理方式",
        ...
        "webcam_fps_slider": "帧率",
        "webcam_image": "预览图像",
        "webcam_device_id_dropdown": "摄像头序号",
        "webcam_mode_radio": "预览模式",
        "webcam_resolution_dropdown": "预览分辨率",
    },
}
