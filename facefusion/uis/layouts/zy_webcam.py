...
from facefusion.uis.components import about, age_modifier_options, deep_swapper_options, download, execution, execution_thread_count, expression_restorer_options, face_debugger_options, face_editor_options, face_enhancer_options, face_swapper_options, frame_colorizer_options, frame_enhancer_options, lip_syncer_options, processors, zy_source,zy_dfm_source, webcam, webcam_options,zy_webcam,zy_webcam_options
		...
		with gradio.Row():
			with gradio.Column(scale = 4):
				...
				with gradio.Blocks():
					download.render()
				with gradio.Blocks():
					zy_webcam_options.render()
				with gradio.Blocks():
					zy_source.render()
				with gradio.Blocks():
					zy_dfm_source.render()
